...
<head>
	...
	div.absolute2
	{
		...
		border-radius: 10px;
		border: 3px solid #625E5E;
		background: url(IMG/8.jpeg) no-repeat;
...
<body>
	...
	<div class="relative">
		...
		<div class="absolute1">
			<h1>
				ICC WORLD CUP <div class="o">/</div> <div class="f">1999</div> <div class="o">/</div> <div class="f">Australia</div>
			<br><hr></h1>
		</div>
		...
		<div class="absolute4" style="top:810px">
			<footer>
